...
export default function EveryonePollDetailPage({
	...
	const ogUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/everyone-polls/${poll.data.id}`;

	return (
		<>
			<Head>
				<title>{ogTitle} - 모두의 투표</title>
